...
if ( $resume['contact']['email'] || $resume['contact']['phone'] || $resume['contact']['website'] || $resume['contact']['address'] ):
	...
	?><style type="text/css">
		<?php echo '#rb-template-' . $rand_rbt; ?> .rbt-contact-info,
		<?php echo '#rb-template-' . $rand_rbt; ?> .rbt-ci-block { border-color: <?php echo 'rgba( ' . $border_rgb['r'] . ', ' . $border_rgb['g'] . ', ' . $border_rgb['b'] . ', 0.2 );'; ?> }
		<?php echo '#rb-template-' . $rand_rbt; ?> .rbt-contact-info a { color:<?php echo $resume['display']['highlight_color']; ?>; }
		<?php echo '#rb-template-' . $rand_rbt; ?> .rbt-contact-info svg path { stroke:<?php echo $resume['display']['text_color']; ?>; }
		<?php echo '#rb-template-' . $rand_rbt; ?> .rbt-contact-info,
		<?php echo '#rb-template-' . $rand_rbt; ?> .rbt-contact-info a:hover { color:<?php echo $resume['display']['text_color']; ?>; }	
	</style><?php
