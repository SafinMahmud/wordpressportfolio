...
?><style type="text/css">
	...
	<?php echo '#rb-template-' . $rand_rbt; ?> .rbt-header .rb-button { background:<?php echo $resume['display']['highlight_color']; ?>; }
	<?php echo '#rb-template-' . $rand_rbt; ?> .rbt-header .rb-button:hover { background:<?php echo $resume['display']['text_color']; ?>; }
